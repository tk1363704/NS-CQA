...
TEST_QUESTION_PATH = '../data/auto_QA_data/mask_even/PT_test.question'
TEST_ACTION_PATH = '../data/auto_QA_data/mask_even/PT_test.action'
...
if __name__ == "__main__":
    ...
    if args.mode == "test":
        ...
        if args.int:
            ...
            if args.dataset == "csqa":
                phrase_pairs, emb_dict = data.load_data_from_existing_data(TEST_QUESTION_PATH_INT,
